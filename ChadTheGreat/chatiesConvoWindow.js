...
(function () {
    ...
    const MODULE_KEY = "chatiesConvoWindow";
    ...
    function patchInputFocus() {
        if (HTMLTextAreaElement.prototype.__chatiesConvoFocusPatched260704) return;

        const originalFocus = HTMLTextAreaElement.prototype.focus;
        HTMLTextAreaElement.prototype.focus = function () {
            if (isModuleOn() && isChadInput(this) && Date.now() > allowInputFocusUntil260704_j4n8vb) {
                return;
            }
            return originalFocus.apply(this, arguments);
        };

        HTMLTextAreaElement.prototype.__chatiesConvoFocusPatched260704 = true;
    ...
    function decorateChatiesPanel() {
        ...
        const section = renderMessagesSection();
    ...
    window.Chad.chatiesConvoWindow = {
        refreshRepoMessages,
        decorateChatiesPanel
    };
