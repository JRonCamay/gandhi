...
This file is BlokSearch's searchable identity catalog.
...
Every AI that creates, edits, moves, retires, or deletes BlokSearch project-level declarations must update this file during the same task.
