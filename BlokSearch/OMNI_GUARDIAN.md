...
This file is BlokSearch's project knowledge map.
...
Every AI that creates, edits, moves, retires, or deletes reusable BlokSearch systems must update this file during the same task.
