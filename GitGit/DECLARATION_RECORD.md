...
This file is GitGit's searchable identity catalog.
...
Every AI that creates, edits, moves, retires, or deletes GitGit project-level declarations must update this file during the same task.
