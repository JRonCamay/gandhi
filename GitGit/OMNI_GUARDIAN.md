...
This file is GitGit's project knowledge map.
...
Every AI that creates, edits, moves, retires, or deletes reusable GitGit systems must update this file during the same task.
