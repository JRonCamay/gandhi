...
(function(){
  ...
  const ID="qc-lite-root",API="http://127.0.0.1:8765/quietchat/api",DAEMON="http://127.0.0.1:8766",POS="qc-lite-pos-v1",VER="0.3.11",VIRT=28;
  ...
  function render(d,shift=""){
    ...
    else if(shift==="top")box.scrollTop=pos*VIRT+10;
    else if(shift==="bottom")box.scrollTop=pos*VIRT+10;
    else if(shift==="virtual")box.scrollTop=pos*VIRT+10;
