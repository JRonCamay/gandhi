SHAGGY OPERATING PROTOCOL v2
* Strictly must be followed

0.  RECEIVE TASK
-   LOAD PROJECTS>SHAGGY_OPERATING_PROTOCOL_v2.md
...
-   Read AGENT_TASKS/Shaggy_currentTasks.md
-   Create if missing.
...
-   Reload Shaggy_currentTasks.md
-   Reconstruct the current task model.

10. TASK CHANGE

-   Immediately overwrite Shaggy_currentTasks.md.
