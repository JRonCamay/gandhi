...
This file is Composer's project knowledge map.
...
Every AI that creates, edits, moves, retires, or deletes reusable Composer systems must update this file during the same task.
