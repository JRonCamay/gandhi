...
This file is Composer's searchable identity catalog.
...
Every AI that creates, edits, moves, retires, or deletes Composer project-level declarations must update this file during the same task.
